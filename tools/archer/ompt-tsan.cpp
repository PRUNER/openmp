...
static void ompt_tsan_sync_region(ompt_sync_region_kind_t kind,
...
static void ompt_tsan_task_dependences(ompt_data_t *task_data,
  ...
  if (ndeps > 0) {
    ...
    std::memcpy(Data->Dependencies, deps,
                sizeof(ompt_task_dependence_t) * ndeps);
