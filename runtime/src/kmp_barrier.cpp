                            ...
                            USE_ITT_BUILD_ARG(void * itt_sync_obj) )
{
    ...
    if (!KMP_MASTER_TID(tid)) {
        ...
        for (i=1; i<nproc; ++i) {
            ...
            ANNOTATE_BARRIER_AFTER(other_threads[ i ]);
#if USE_ITT_BUILD && USE_ITT_NOTIFY
    ...
    if (KMP_MASTER_TID(tid)) {
        ...
        if (nproc > 1) {
            ...
            for (i=1; i<nproc; ++i) {
                ...
                ANNOTATE_BARRIER_BEFORE(other_threads[i]);
        ...
        flag.wait(this_thr, TRUE
                  USE_ITT_BUILD_ARG(itt_sync_obj) );
        ANNOTATE_BARRIER_AFTER(this_thr);
#if USE_ITT_BUILD && USE_ITT_NOTIFY
                          ...
                          USE_ITT_BUILD_ARG(void *itt_sync_obj) )
{
    ...
    if (child_tid < nproc) {
        ...
        do {
            ...
            flag.wait(this_thr, FALSE
                      USE_ITT_BUILD_ARG(itt_sync_obj) );
            ANNOTATE_BARRIER_AFTER(child_thr);
#if USE_ITT_BUILD && USE_ITT_NOTIFY
                           ...
                           USE_ITT_BUILD_ARG(void *itt_sync_obj) )
{
    ...
    if (child_tid < nproc) {
        ...
        do {
            ...
            ANNOTATE_BARRIER_BEFORE(child_thr);
